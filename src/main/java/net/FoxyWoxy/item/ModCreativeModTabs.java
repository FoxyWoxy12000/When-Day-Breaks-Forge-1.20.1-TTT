...
public class ModCreativeModTabs {
 ...
 public static final RegistryObject<CreativeModeTab> WHEN_DAY_BREAKES_TAB = CREATIVE_MODE_TABS.register("whendaybreaks_tab",
            () -> CreativeModeTab.builder().icon(() -> new ItemStack(ModItems.CONSUMABLE_FLESH_CHUNK.get()))
                    ...
                    pOutput.accept(ModItems.COOKED_CONSUMABLE_FLESH_CHUNK.get());

                    pOutput.accept(ModBlocks.FLESH_BLOCK.get());
                    pOutput.accept(ModBlocks.FLESH_BLOCK_COOKED.get());
                    })
                    .build());


    public static final DeferredRegister<CreativeModeTab> TESTING_CREATIVE_MODE_TABS =
            DeferredRegister.create(Registries.CREATIVE_MODE_TAB, whendaybreaks.MODID);
    public static final RegistryObject<CreativeModeTab> TESTING_TAB = TESTING_CREATIVE_MODE_TABS.register("test_tab",
            () -> CreativeModeTab.builder().icon(() -> new ItemStack(ModItems.EXECUTION_SWORD.get()))
                    .title(Component.translatable("creativetab.test_tab"))
                    .displayItems((pParameters, pOutput) -> {

                        pOutput.accept(ModItems.GOLDY_WEAPON.get());
                        pOutput.accept(ModBlocks.TRIPLE_T_BLOCK.get());
                        pOutput.accept(ModBlocks.EVIL_PAINTER_REGECTED_BLOCK.get());
    ...
    public static void  register(IEventBus eventBus) {
        ...
        TESTING_CREATIVE_MODE_TABS.register(eventBus);
    }
}
